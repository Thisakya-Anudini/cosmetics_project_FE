...
const AboutUsPage = () => {
  return (
    <div className="min-h-screen bg-fuchsia-100 py-8 px-6 flex flex-col items-center">
      ...
      <div className="w-full md:w-[900px] flex flex-col items-center justify-center">
        <div className="bg-cyan-900 flex justify-center items-center rounded-lg shadow-lg">
          <img 
        ...
        <div className=" max-w-5xl bg-cyan-900 p-8 mt-[-80px] rounded-lg shadow-lg space-y-6">
          {/* Company Overview */}
      ...
      <div className="w-full md:w-[900px] relative mt-10">
        <div className="bg-pink-200 shadow-xl rounded-lg space-y-1 p-8">
      ...
      <div className="w-full md:w-[900px] relative mt-10">
        ...
        <div className="relative z-10 max-w-5xl bg-pink-200 shadow-xl rounded-lg space-y-8 p-8">
      ...
      <div className="w-full bg-cyan-900 py-10 mt-10">
