          ...
          <div className="w-full md:w-[49%] h-full flex flex-col items-center pt-[50px]">
            ...
            <div className="w-full flex flex-col items-center mt-[20px]">
              {product.labelledPrice > product.price ? (
                <div>
                  <span className="text-2xl font-semibold line-through mr-[20px] text-gray-600">
            ...
            <div className="w-full flex flex-row justify-center items-center mt-[20px] gap-[10px]">
              <button
                ...
                className="w-[200px] h-[50px] cursor-pointer rounded-xl shadow-2xl text-white bg-pink-900 border-[3px] border-pink-900 hover:bg-white hover:text-pink-900"
              >
                Buy Now
              </button>
              <button
                className="w-[200px] h-[50px] cursor-pointer rounded-xl shadow-2xl text-white bg-pink-600 border-[3px] border-pink-600 hover:bg-white hover:text-pink-600"
                onClick={() => {
                  addToCart(product, 1);
